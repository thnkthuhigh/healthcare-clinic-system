...
export function BookingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-gradient-to-br from-blue-600 to-teal-600 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 rounded-full px-4 py-1.5 mb-4">
            <span className="material-symbols-outlined text-sm">calendar_add_on</span>
            <span className="text-sm font-medium">Đặt lịch khám trực tuyến</span>
          </div>
          <h1 className="text-3xl sm:text-4xl font-bold mb-2">Đặt lịch khám</h1>
          <p className="text-blue-100">Hoàn tất nhanh trong 5 bước</p>
        </div>
      </div>

      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="mx-auto max-w-lg bg-white border border-slate-200 rounded-2xl p-5 sm:p-6 shadow-sm">
          <div className="mb-4">
            {step > 1 && step < 5 && (
              <button
                type="button"
